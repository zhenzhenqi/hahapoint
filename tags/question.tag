<question>
	...
	<button class="btn btn-primary submitBtn" type="button" name="button" data-toggle="modal" data-target="#exampleModal" onclick = {check}>Submit</button>
